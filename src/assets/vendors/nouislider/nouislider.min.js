  ...
  function D(t, v, o) {
    ...
    function M(t, e) {
      ...
      return (
        ...
        v.keyboardSupport &&
          ...
          n.addEventListener('keydown', function (t) {
            return (function (t, e) {
              ...
              v.dir && !v.ort
                ? r.reverse()
                : v.ort && !v.dir && (n.reverse(), i.reverse());
              var a,
              ...
              if ((t.preventDefault(), p || c)) {
                ...
                a = d
                  ? v.spectrum.xVal[v.spectrum.xVal.length - 1]
                  : v.spectrum.xVal[0];
              return (
                rt(e, y.toStepping(a), !0, !0),
                J('slide', e),
                J('update', e),
                J('change', e),
                J('set', e),
        ...
        0 === e
          ? ht(n, v.cssClasses.handleLower)
          : e === v.handles - 1 && ht(n, v.cssClasses.handleUpper),
        r
      );
    }
    function O(t, e) {
    ...
    function j(e, i, o) {
      ...
      return (
        ht(a, v.cssClasses.pips),
        ht(
          a,
          0 === v.ort ? v.cssClasses.pipsHorizontal : v.cssClasses.pipsVertical
        ),
          ...
          !(function (t, e, r) {
            if ((r = i ? i(e, r) : r) !== N) {
              ...
              ((n.className = p(r, v.cssClasses.marker)),
                (n.style[v.style] = t + '%'),
                U < r &&
                  (((n = A(a, !1)).className = p(r, v.cssClasses.value)),
    ...
    function _(t, e) {
      (e.handle && (mt(e.handle, v.cssClasses.active), (g -= 1)),
        e.listeners.forEach(function (t) {
          E.removeEventListener(t[0], t[1]);
        }),
        0 === g &&
          (mt(h, v.cssClasses.drag),
          et(),
          t.cursor &&
    ...
    function n(t) {
      ...
      (v.events.snap || pt(h, v.cssClasses.tap, v.animationDuration),
        ...
        J('change', r, !0),
        J('set', r, !0),
        v.events.snap && I(t, { handleNumbers: [r] }));
    }
    function W(t) {
      var e = q(t.calcPoint),
        r = y.getStep(e),
    ...
    function K(t, e, r, n, i, o) {
      return (
        1 < u.length &&
          !v.events.unconstrained &&
          (n && 0 < e && (r = Math.max(r, t[e - 1] + v.margin)),
          i && e < u.length - 1 && (r = Math.min(r, t[e + 1] - v.margin))),
        1 < u.length &&
          v.limit &&
          (n && 0 < e && (r = Math.min(r, t[e - 1] + v.limit)),
          i && e < u.length - 1 && (r = Math.max(r, t[e + 1] - v.limit))),
        v.padding &&
          (0 === e && (r = Math.max(r, v.padding[0])),
    ...
    return (
      ht((e = h), v.cssClasses.target),
      0 === v.dir ? ht(e, v.cssClasses.ltr) : ht(e, v.cssClasses.rtl),
      0 === v.ort
        ? ht(e, v.cssClasses.horizontal)
        : ht(e, v.cssClasses.vertical),
      ht(
        e,
        'rtl' === getComputedStyle(e).direction
          ? v.cssClasses.textDirectionRtl
          : v.cssClasses.textDirectionLtr
      ),
      ...
      (function (t, e) {
        ...
        for (var n = 0; n < v.handles; n++)
          (u.push(M(e, n)), (m[n] = n), a.push(O(r, t[n + 1])));
      })(v.connect, l),
      (p = v.events).fixed ||
        u.forEach(function (t, e) {
