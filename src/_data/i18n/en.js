export default {
  ...
  // Meta
  siteTitle: 'Hair & Hair - Trichologist Krakow | Trichology Clinic',
  siteDescription:
    'Professional trichology clinic Hair & Hair in Krakow, Poland. Expert consultations, trichological treatments, hair loss therapy, and scalp treatments. Natural healing methods.',
  // Under Construction Banner
  underConstruction: {
    title: '🚧 Under Construction',
    message: 'We are working on a new version of the website. More content coming soon!',
  },
  // Navigation
  nav: {
    home: 'About me',
  ...
  treatments: {
    ...
    faq: {
      q1: 'Is a trichological/oxygen infusion treatment painful?',
      a1: 'No, the treatments are non-invasive and painless.',
      q2: 'Do I need a consultation before a treatment?',
      a2: 'Not always. Treatments can be performed without a prior consultation, but for complex issues I recommend a consultation.',
      q3: 'How many treatments are needed?',
      a3: 'The number of treatments depends on the issue and is selected individually. I usually recommend 4–6 treatments spaced 2–4 weeks apart, followed by home care and optional maintenance treatments every few months.',
      q4: 'Does microneedling mesotherapy require a prior consultation?',
      a4: 'Yes. Before microneedling mesotherapy I always rule out individual contraindications.',
    },
    faqCta: {
  ...
  consultations: {
    ...
    data: {
      ...
      descriptionCd: "Each client receives an <b>individual Trichoplan</b> after the visit – clear, tailored recommendations for the beginning, including home care, supplement recommendations, and next steps in working towards a healthy scalp and hair, such as treatment and dietary recommendations. <br><br> See you at the consultation!",
    },
    faq: {
      ...
      a3: 'You will receive a Trichoplan — individual care recommendations, supplement guidance, and treatment recommendations.',
      q4: 'How should I prepare for the consultation?',
      a4: 'Before the visit, prepare information about your current care routine, any health issues, and supplements or medications you take. For 24 hours before the consultation, avoid washing your hair, styling products, scalp peeling, and hairdresser treatments so the scalp can be assessed in its natural state.',
      q5: 'Can I dye my hair before the visit?',
      a5: 'I recommend avoiding hair coloring for 2 weeks before the consultation so the scalp is in its natural state. If you dye your hair regularly, let me know when booking and I will adjust the preparation guidance.',
    },
    faqCta: {
      subtitle: 'Have questions?',
  ...
  consultationsOnline: {
    ...
    faq: {
      ...
      a1: 'No, but it can be a sufficient first step in working on the problem.',
      q2: 'How should I prepare for an online consultation?',
      a2: 'Fill out the form you receive and take photos according to the provided instructions.',
  ...
  headSpa: {
    ...
    faq: {
      ...
      a1: 'It is a ritual that combines relaxation with scalp and hair therapy using individually selected trichological products.',
      q2: 'Who is Head SPA for?',
      a2: 'Primarily for people who want to combine deep relaxation with improving scalp and hair condition.',
      q3: 'Can I do Head SPA if I have scalp problems?',
      a3: 'Yes. Before each Head SPA treatment, the trichologist assesses the scalp and selects the right products and techniques.',
    },
    faqCta: {
      subtitle: 'Have questions?',
  ...
  pricing: {
    ...
    headSPA: {
      title: 'Head SPA',
      a: 'Head Spa TRICHOLOGY TREATMENT',
      b: 'Head Spa PERFECT SKIN&HAIR',
      c: 'Head Spa BASIC',
      d: 'Head Spa MEN',
    },
    startingPacks: {
  ...
  home: {
    ...
    slider: {
      slide1: {
        ...
        title: 'Open the Door to Healthy <br> and Beautiful Hair',
        button: 'Consultation',
      },
      slide2: {
        subtitle: 'More than just care',
        title: 'Discover the Secret of Healthy <br> Scalp and Strong Hair',
        button: 'Treatments',
      },
      slide3: {
        subtitle: 'DISCOVER THE POWER OF HEAD SPA',
        title: 'Harmony for Your Scalp and Hair',
        button: 'Head SPA',
      },
    },
    intro: {
      tagline: 'Get to know me',
      title: 'Healthy scalp and hair. Calm, conscious approach to therapy.',
      imageAlt: 'Natalia Kuklińska - Trichologist, founder of Hair & Hair',
      text: 'My name is <b>Natalia Kuklińska</b>. I am an experienced trichologist who performs my work with passion. <br>I am a graduate of the <b>Collegium Medicum of the Jagiellonian University</b> in Krakow, where I defended my diploma thesis in trichology. <br><br>For 4 years I have been running my own trichological space <b>HAIR & HAIR</b>, where I solve hair and scalp problems. <br><br>At <b>HAIR & HAIR</b>, I focus on the causes of scalp and hair problems, combining precise diagnostics with tailored therapy and an individual approach.',
      points: {
        experience: '8 years of experience',
        lecturer: 'Academic lecturer',
        nursing: 'Nursing student',
        collaboration: 'Cooperation with dermatologist and other specialists',
      },
      button: 'More',
    },
    counter: {
      experience: 'Years of experience',
      years: 'Years in HAIR & HAIR',
      treatments: 'Head Spa Treatments',
      consultations: 'Consultations',
    },
    process: {
      tagline: '3 steps',
    ...
    testimonials: {
      ...
      title: 'Trust that I build with results',
      text: 'The trust of my clients is the best confirmation of the quality of my work and the individual approach to each therapy.',
      client: 'Client',
      clientFemale: 'Client',
      review1:
        'Bardzo polecam Panią Natalię. W prosty sposób wyjaśniła, co może być przyczyną moich dolegliwości włosowych. Dokładnie zostało przeprowadzone badanie skóry głowy. Jestem bardzo zadowolona z wizyty.',
      review2:
        'Zabieg head&spa przeszedł moje oczekiwania! Cudowny relaks, dokładność w masowaniu i dbałość o każdy szczegół! Polecam gorąco!',
      review3:
        'Rewelacja, jestem bardzo zadowolony z wizyt. Efekty niemal natychmiastowe. Bardzo dobra komunikacja. Dziękuję!',
      review4: 'Amazing experience! The Head Spa felt so well.',
      review5:
        'Bardzo kompetentna Pani. Wiedza na wysokim poziomie i wykorzystanie jej w praktyce daje niesamowite efekty. Polecam każdemu :)',
      review6:
        'Polecam, wizyta komfortowa, Pani Natalia bardzo konkretna i wyczerpująco wyjaśniła problem i plan leczenia.',
      review7:
        'Trafna diagnoza. Skuteczne wskazówki dotyczące postępowania przyniosły zamierzone efekty. Polecam.',
    },
    instagram: {
      title: 'Follow me on Instagram',
    },
    cta: {
      title: 'The place where your Trichological Therapy begins',
  ...
  notFound: {
    ...
    text: 'Sorry, the page you are trying to visit does not exist or has been moved.',
  ...
  // Common
  common: {
    address: 'ul. Ruczaj 17A, premises B',
    city: 'Krakow',
    postalCode: '30-409',
  },
};
